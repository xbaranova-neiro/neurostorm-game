...
**Форма GetCourse на `github.io`:** игра открывает её **в новой вкладке** (встроенный виджет с чужого домена часто блокируется). Подробнее — [neurostorm/README.md](neurostorm/README.md).
